...
export const metadata: Metadata = {
  ...
  description: 'Stride turns walks and runs into commitments. Stake USDm on a goal, prove it with GPS on Celo, and get your stake back plus a bonus when you finish.',
  applicationName: 'Stride',
  keywords: ['Stride', 'Celo', 'MiniPay', 'USDm', 'fitness', 'walking', 'running', 'staking', 'move to earn', 'web3 fitness'],
  authors: [{ name: 'Stride' }],
  ...
  openGraph: {
    ...
    description: 'Stake USDm on a walk or run goal, prove it with GPS on Celo, and earn your stake back plus a bonus.',
    locale: 'en_US',
  },
  twitter: {
