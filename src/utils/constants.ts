...
export const USDm_ADDRESS = (process.env.NEXT_PUBLIC_USDm_ADDRESS || '0x765DE816845861e75A25fCA122bb6898B8B1282a') as `0x${string}`
...
export const MIN_STAKE_CELO = 0.01
